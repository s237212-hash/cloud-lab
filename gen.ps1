...
8. print('I want {0} pieces of item {1} for {2} dollars.'.format(3, 567, 49.95))
...
# Split text by newlines and add with basic formatting
...
$path = "e:\cloud-lab\loi_giai_python.docx"
